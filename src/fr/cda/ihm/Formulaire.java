...
public class Formulaire
{
    ...
    */
    ...
    /**
     * Inits the formulaire.
     *
     * @param titre the titre
     * @param app the app
     * @param synchrone the synchrone
     * @param width the width
     * @param height the height
     * @param avecFrame the avec frame
     */
     ...
     *
     * @throws FormulaireException the formulaire exception
     */
    ...
    */
    ...
    /**
     * The listener interface for receiving submit events.
     * The class that is interested in processing a submit
     * event implements this interface, and the object created
     * with that class is registered with a component using the
     * component's <code>addSubmitListener<code> method. When
     * the submit event occurs, that object's appropriate
     * method is invoked.
     *
     * @see SubmitEvent
     */
    ...
    class SubmitListener implements ActionListener
    {
        ...
        /**
         * Instantiates a new submit listener.
         *
         * @param form the form
    ...
    /**
     * The listener interface for receiving formulaireWindow events.
     * The class that is interested in processing a formulaireWindow
     * event implements this interface, and the object created
     * with that class is registered with a component using the
     * component's <code>addFormulaireWindowListener<code> method. When
     * the formulaireWindow event occurs, that object's appropriate
     * method is invoked.
     *
     * @see FormulaireWindowEvent
     */
	 ...
	 * @param res the res
	 */
	public void setValeurChamp(String nom, boolean res) {
